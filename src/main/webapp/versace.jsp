        ...
        <section id="brand-products">
            ...
            <div class="box-brand-products">
                <div class="box-brand-product-element">     <!-- 1 sản phẩm trong hàng 1 -->
                    <a href="#">
                        <div class="img-product">
                            <img src="images/brand-elements/versace/dh1.png" alt="dongho1">
                ...
                <div class="box-brand-product-element">
                    <a href="#">
                        <div class="img-product">
                            <img src="images/brand-elements/versace/dh2.png" alt="dongho2">
                            <div class="icon-brand-products">
                                <button class="icon heart-icon" alt="tim"></button>
                                <button class="icon cart-icon" alt="cart"></button>
                            </div>
                ...
                <div class="box-brand-product-element">
                    <a href="#">
                        <div class="img-product">
                            <img src="images/brand-elements/versace/dh3.png" alt="dongho3">
                            <div class="icon-brand-products">
                                <button class="icon heart-icon" alt="tim"></button>
                                <button class="icon cart-icon" alt="cart"></button>
                            </div>
                ...
                <div class="box-brand-product-element">
                    <a href="#">
                        <div class="img-product">
                            <img src="images/brand-elements/versace/dh4.png" alt="dongho4">
                            <div class="icon-brand-products">
                                <button class="icon heart-icon" alt="tim"></button>
                                <button class="icon cart-icon" alt="cart"></button>
                            </div>
            ...
            <div class="box-brand-products">
                <div class="box-brand-product-element">
                    <a href="#">
                        <div class="img-product">
                            <img src="images/brand-elements/versace/dh5.png" alt="dongho5">
                            <div class="icon-brand-products">
                                <button class="icon heart-icon" alt="tim"></button>
                                <button class="icon cart-icon" alt="cart"></button>
                            </div>
                ...
                <div class="box-brand-product-element">
                    <a href="#">
                        <div class="img-product">
                            <img src="images/brand-elements/versace/dh6.png" alt="dongho6">
                            <div class="icon-brand-products">
                                <button class="icon heart-icon" alt="tim"></button>
                                <button class="icon cart-icon" alt="cart"></button>
                            </div>
                ...
                <div class="box-brand-product-element">
                    <a href="#">
                        <div class="img-product">
                            <img src="images/brand-elements/versace/dh7.png" alt="dongho7">
                            <div class="icon-brand-products">
                                <button class="icon heart-icon" alt="tim"></button>
                                <button class="icon cart-icon" alt="cart"></button>
                            </div>
                ...
                <div class="box-brand-product-element">
                    <a href="#">
                        <div class="img-product">
                            <img src="images/brand-elements/versace/dh8.png" alt="dongho8">
                            <div class="icon-brand-products">
                                <button class="icon heart-icon" alt="tim"></button>
                                <button class="icon cart-icon" alt="cart"></button>
                            </div>
