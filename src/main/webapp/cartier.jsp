    ...
    <section id="brand-elements-page">
        <section id="banner-brand">
            <div class="picture-brand"
                 style="width: 100%;
                    height: 82%;
                    background-image: url(images/brand-elements/cartier/cartier-banner.png);
            ...
            <div class="navbar-brand">
                <div class="navbar-content-brand">
                    ...
                    &nbsp;/&nbsp; <a href="cartier.jsp">Cartier</a>
                </div>
            </div>
        </section>
        <section id="intro-brand">
            <div class="intro-brand-content">
                <h1 class="text-center">CARTIER COLLECTION</h1>
                <div class="detail-cont">
                    Cartier was founded in Paris by Louis-Francois Cartier, son of a powder horn maker.
                    The year was 1847; just four short years later, Napoleon III came to power and through Countess Nieuwerkerke,
                    the young Cartier was able to become a supplier to the court, selling Empress Eugenie a silver tea service in 1859.
                </div>
            </div>
        </section>
        <section id="brand-products">
            ...
            <c:forEach var="product" items="${sessionScope.products}" varStatus="loop">
                <c:if test="${product.brand.name == 'cartier'}">
