    ...
    <section id="brand-elements-page">
        <section id="banner-brand">
            <div class="picture-brand"
                 style="width: 100%;
                    height: 82%;
                    background-image: url(images/brand-elements/omega/omega-banner.png);
            ...
            <div class="navbar-brand">
                <div class="navbar-content-brand">
                    ...
                    &nbsp;/&nbsp; <a href="omega.jsp">Omega</a>
                </div>
            </div>
        </section>
        <section id="intro-brand">
            <div class="intro-brand-content">
                <h1 class="text-center">OMEGA COLLECTION</h1>
                <div class="detail-cont">
                    The Omega Watch Company was founded by Louis Brandt in La Chaux de Fonds, Switzerland in 1848.
                    Brandt, 23 years old, began by hand assembling watches from parts produced by local craftsmen.
                    When Louis Brandt passed away in 1879, he left the company to his two sons Louis-Paul and Cesar,
                    who moved Omega to Bienne in January 1880.
                </div>
            </div>
        </section>
        <section id="brand-products">
            ...
            <div class="box-brand-products">
                <div class="box-brand-product-element">     <!-- 1 sản phẩm trong hàng 1 -->
                    <a href="#">
                        <div class="img-product">
                            <img src="images/brand-elements/omega/dh1.png" alt="dongho1">
                ...
                <div class="box-brand-product-element">
                    <a href="#">
                        <div class="img-product">
                            <img src="images/brand-elements/omega/dh2.png" alt="dongho2">
                            <div class="icon-brand-products">
                                <button class="icon heart-icon" alt="tim"></button>
                                <button class="icon cart-icon" alt="cart"></button>
                            </div>
                ...
                <div class="box-brand-product-element">
                    <a href="#">
                        <div class="img-product">
                            <img src="images/brand-elements/omega/dh3.png" alt="dongho3">
                            <div class="icon-brand-products">
                                <button class="icon heart-icon" alt="tim"></button>
                                <button class="icon cart-icon" alt="cart"></button>
                            </div>
                ...
                <div class="box-brand-product-element">
                    <a href="#">
                        <div class="img-product">
                            <img src="images/brand-elements/omega/dh4.png" alt="dongho4">
                            <div class="icon-brand-products">
                                <button class="icon heart-icon" alt="tim"></button>
                                <button class="icon cart-icon" alt="cart"></button>
                            </div>
            ...
            <div class="box-brand-products">
                <div class="box-brand-product-element">
                    <a href="#">
                        <div class="img-product">
                            <img src="images/brand-elements/omega/dh5.png" alt="dongho5">
                            <div class="icon-brand-products">
                                <button class="icon heart-icon" alt="tim"></button>
                                <button class="icon cart-icon" alt="cart"></button>
                            </div>
                ...
                <div class="box-brand-product-element">
                    <a href="#">
                        <div class="img-product">
                            <img src="images/brand-elements/omega/dh6.png" alt="dongho6">
                            <div class="icon-brand-products">
                                <button class="icon heart-icon" alt="tim"></button>
                                <button class="icon cart-icon" alt="cart"></button>
                            </div>
                ...
                <div class="box-brand-product-element">
                    <a href="#">
                        <div class="img-product">
                            <img src="images/brand-elements/omega/dh7.png" alt="dongho7">
                            <div class="icon-brand-products">
                                <button class="icon heart-icon" alt="tim"></button>
                                <button class="icon cart-icon" alt="cart"></button>
                            </div>
                ...
                <div class="box-brand-product-element">
                    <a href="#">
                        <div class="img-product">
                            <img src="images/brand-elements/omega/dh8.png" alt="dongho8">
                            <div class="icon-brand-products">
                                <button class="icon heart-icon" alt="tim"></button>
                                <button class="icon cart-icon" alt="cart"></button>
                            </div>
