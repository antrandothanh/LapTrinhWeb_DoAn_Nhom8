...
<div style="background-color: #BA68C8; padding-bottom: 77px; padding-top: 57px">
    <div class="container rounded bg-white mt-5">
        <div class="row">
            <div class="col-md-4 border-right">
                <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img class="rounded-circle mt-5" src="picture/ok.jpg" width="90"><span class="font-weight-bold"><%=user.getName()%></span><span class="text-black-50"><%=user.getEmail()%></span></div>
            </div>
            <div class="col-md-8">
                <div class="p-3 py-5">
