    ...
    <section id="brand-elements-page">
        <section id="banner-brand">
            <div class="picture-brand"
                 style="width: 100%;
                    height: 82%;
                    background-image: url(images/brand-elements/hublot/hublot-banner.png);
            ...
            <div class="navbar-brand">
                <div class="navbar-content-brand">
                    ...
                    &nbsp;/&nbsp; <a href="hublot.jsp">Hublot</a>
                </div>
            </div>
        </section>
        <section id="intro-brand">
            <div class="intro-brand-content">
                <h1 class="text-center">HUBLOT COLLECTION</h1>
                <div class="detail-cont">
                    The gold Hublot watch, created by Carlo Crocco in 1980, a watch with the first natural
                    black rubber bracelet ever seen in the watch making scenario,
                    has turned into the inspiration of lots of watch makers and it has become absolutely famous worldwide.
                </div>
            </div>
        </section>
        <section id="brand-products">
            ...
            <div class="box-brand-products">
                <div class="box-brand-product-element">     <!-- 1 sản phẩm trong hàng 1 -->
                    <a href="#">
                        <div class="img-product">
                            <img src="images/brand-elements/hublot/dh1.png" alt="dongho1">
                ...
                <div class="box-brand-product-element">
                    <a href="#">
                        <div class="img-product">
                            <img src="images/brand-elements/hublot/dh2.png" alt="dongho2">
                            <div class="icon-brand-products">
                                <button class="icon heart-icon" alt="tim"></button>
                                <button class="icon cart-icon" alt="cart"></button>
                            </div>
                ...
                <div class="box-brand-product-element">
                    <a href="#">
                        <div class="img-product">
                            <img src="images/brand-elements/hublot/dh3.png" alt="dongho3">
                            <div class="icon-brand-products">
                                <button class="icon heart-icon" alt="tim"></button>
                                <button class="icon cart-icon" alt="cart"></button>
                            </div>
                ...
                <div class="box-brand-product-element">
                    <a href="#">
                        <div class="img-product">
                            <img src="images/brand-elements/hublot/dh4.png" alt="dongho4">
                            <div class="icon-brand-products">
                                <button class="icon heart-icon" alt="tim"></button>
                                <button class="icon cart-icon" alt="cart"></button>
                            </div>
            ...
            <div class="box-brand-products">
                <div class="box-brand-product-element">
                    <a href="#">
                        <div class="img-product">
                            <img src="images/brand-elements/hublot/dh5.png" alt="dongho5">
                            <div class="icon-brand-products">
                                <button class="icon heart-icon" alt="tim"></button>
                                <button class="icon cart-icon" alt="cart"></button>
                            </div>
                ...
                <div class="box-brand-product-element">
                    <a href="#">
                        <div class="img-product">
                            <img src="images/brand-elements/hublot/dh6.png" alt="dongho6">
                            <div class="icon-brand-products">
                                <button class="icon heart-icon" alt="tim"></button>
                                <button class="icon cart-icon" alt="cart"></button>
                            </div>
                ...
                <div class="box-brand-product-element">
                    <a href="#">
                        <div class="img-product">
                            <img src="images/brand-elements/hublot/dh7.png" alt="dongho7">
                            <div class="icon-brand-products">
                                <button class="icon heart-icon" alt="tim"></button>
                                <button class="icon cart-icon" alt="cart"></button>
                            </div>
                ...
                <div class="box-brand-product-element">
                    <a href="#">
                        <div class="img-product">
                            <img src="images/brand-elements/hublot/dh8.png" alt="dongho8">
                            <div class="icon-brand-products">
                                <button class="icon heart-icon" alt="tim"></button>
                                <button class="icon cart-icon" alt="cart"></button>
                            </div>
