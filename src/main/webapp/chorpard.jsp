    ...
    <section id="brand-elements-page">
        <section id="banner-brand">
            <div class="picture-brand"
                 style="width: 100%;
                    height: 82%;
                    background-image: url(images/brand-elements/chopard/chopard-banner.png);
            ...
            <div class="navbar-brand">
                <div class="navbar-content-brand">
                    ...
                    &nbsp;/&nbsp; <a href="chorpard.jsp">Chorpard</a>
                </div>
            </div>
        </section>
        <section id="intro-brand">
            <div class="intro-brand-content">
                <h1 class="text-center">CHOPARD COLLECTION</h1>
                <div class="detail-cont">
                    Founded in 1860, Louis-Ulysee Chopard (L.U.C.) set out the vision for the manufacture
                    of masterpiece Jewelry and Watches of unique character,
                    blending the talents of both sides of the brand to make a real statement about the mark and its wearer.
                </div>
            </div>
        </section>
        ...
        <section id="brand-products">
            ...
            <c:forEach var="product" items="${sessionScope.products}" varStatus="loop">
                <c:if test="${product.brand.name == 'chorpard'}">
